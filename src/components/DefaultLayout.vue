    ...
    <Disclosure as="nav" class="bg-gray-800" v-slot="{ open, close }">
      ...
      <DisclosurePanel class="md:hidden">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
          <RouterLink v-for="item in navigation" :key="item.name" as="router-link" :to="item.to" @click="close"
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
          <div class="flex items-center px-5">
            <div class="shrink-0">
              <img class="size-10 rounded-full" src="https://randomuser.me/api/portraits/women/26.jpg" alt="" />
            </div>
            <div class="ml-3">
